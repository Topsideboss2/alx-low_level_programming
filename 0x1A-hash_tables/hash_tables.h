 ...
 * @value: The value of corrensponding to a key
 * @next: A pointer to the next node of the List
 * @prev: A pointer to the previous element of the sorted linked list
 * @next: A pointer to the next element of the sorted linked list
 */
